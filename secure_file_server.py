...
# ==== CONFIGURATION ====
SECRET_KEY = //create a dynamic key
PASSWORD = // set a strong password


ENCRYPTION_KEY = //generate dynamic key everytime dont expose it
cipher = Fernet(ENCRYPTION_KEY)

UPLOAD_FOLDER = os.path.abspath("encrypted_files")
os.makedirs(UPLOAD_FOLDER, exist_ok=True)

EMAIL_SENDER = //the sender email to share the cloud storage link eveytime you start the server
EMAIL_PASSWORD = //get your app specific password
EMAIL_RECEIVER = //the reciever email address
...
def send_email(ngrok_url):
    ...
    msg["Subject"] = "Ngrok Server URL-Your personalized cloud storage"
